...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 12, 2025 at 07:15 AM
...
(29, 'A.Y. 2025-2026 Exam Day 1', 1, '2025-08-27 06:57:00', 'Published', 0, 60, NULL, '2025-10-10 21:38:43', 3),
(30, 'djhhjshjdhs', 0, '2025-09-24 06:18:02', 'Unpublished', 1, 60, NULL, NULL, 3),
(31, 'yyyty', 0, '2025-09-24 06:26:50', 'Unpublished', 0, 60, NULL, NULL, 3),
(34, 'A.Y. 2025-2026 Exam Day 5', 0, '2025-10-10 13:38:09', 'Unpublished', 0, 60, NULL, NULL, 3);
...
(9, 'GUBAC', 'MICHAEL', 'ashleynteah.regalado@gmail.com', '$2y$10$Np7FYZstYfIZ75xcWT4r1.sGKkDodXNnSr9kenY0aVzt9u.eNsRoe', '2025-09-24 14:45:13', 3),
(10, 'SANTIAGO', 'MICHAEL', 'regalado.ashleycaryll@gmail.com', '$2y$10$qR6jBGUF/VHG45bBQ1Me/etdOXXFnbc1wAgtqPYSXMf2qcyCBKcPm', '2025-09-24 14:48:58', 3);
...
INSERT INTO `questions` (`id`, `version_id`, `question_type`, `question_text`, `option_a`, `option_b`, `option_c`, `option_d`, `answer`, `points`, `created_at`, `exam_version`, `image_url`) VALUES
(101, 16, 'multiple', '<strong>CP st</strong>ands for?', 'Canton Pancit', 'Cell Phone', 'Call Papi', 'Coke Pepsi', 'B', 1, '2025-05-08 15:18:52', '', NULL),
(102, 16, 'short', 'sample', '', '', '', '', 'sample', 1, '2025-05-08 15:18:52', '', NULL),
(103, 16, 'truefalse', 'sample', 'True', 'False', '', '', 'False', 1, '2025-05-09 01:52:04', '', NULL),
(104, 16, 'truefalse', 'sample', 'True', 'False', '', '', 'True', 1, '2025-05-09 01:53:07', '', NULL),
(106, 20, 'multiple', 'What does the acronym USB stands for?', 'University State Building', 'Universal Serial Bus', 'Unity Sara Bongbong', 'Unli Sabaw Baboy', 'B', 1, '2025-05-09 09:38:28', '', NULL),
(107, 20, 'multiple', '1+1?', '2', '3', '4', '6', 'A', 1, '2025-05-09 09:38:28', '', NULL),
(108, 20, 'short', 'what is the chemical symbol for gold?', '', '', '', '', 'Au', 1, '2025-05-09 13:47:31', '', NULL),
(113, 29, 'multiple', 'What does the USB acronym stands for?', 'Universal Serial Bus', 'Una Bwass Skwela', 'Unli Sabaw Baboy', 'Unity Bongbong Sara', 'A', 1, '2025-09-21 07:27:35', '', NULL),
(119, 30, 'multiple', 'hhghghg', '', '', '', '', 'False', 1, '2025-09-24 06:38:06', '', NULL);
...
(80, 25, 68.67, 8, 8.00, 8.07, NULL, NULL, 0.00, NULL, 0.00, NULL, 8.07, 1, NULL);
...
INSERT INTO `strands` (`id`, `name`, `status`, `created_at`) VALUES
(1, 'HUMSS', 'active', '2025-10-06 09:00:00'),
(2, 'TVL', 'active', '2025-10-06 09:00:00'),
(3, 'STEM', 'active', '2025-10-06 09:00:00'),
(4, 'ABM', 'active', '2025-10-06 09:00:00'),
(5, 'GAS', 'active', '2025-10-06 09:00:00');
...
--
ALTER TABLE `registration`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20260034;
