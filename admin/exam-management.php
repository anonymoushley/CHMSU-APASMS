          ...
          <div class="question-card" id="question-<?= $q_index ?>" data-db-id="<?= $row['id'] ?>">
            <div class="row">
              ...
              <div class="toolbar mb-2">
                <button type="button" class="btn btn-sm btn-outline-secondary" onclick="formatText(this, 'bold')"><b>B</b></button>
                <button type="button" class="btn btn-sm btn-outline-secondary" onclick="formatText(this, 'italic')"><i>I</i></button>
                <button type="button" class="btn btn-sm btn-outline-secondary" onclick="addImage(this)">🖼️</button>
              </div>
            </div>
...
<div class="modal fade" id="saveQuestionsModal" tabindex="-1" aria-labelledby="saveQuestionsModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-success" id="confirmSaveQuestions">
...
function formatText(button, command) {
  ...
  const editor = questionCard.querySelector('[contenteditable="true"]');
