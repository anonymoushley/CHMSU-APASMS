...
if (isset($_GET['success'])) {
    ...
    echo '<div class="toast-container position-fixed top-0 end-0 p-3" style="z-index: 1060;">'
        . '<div id="successToast" class="toast align-items-center text-bg-success border-0" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="1500">'
        .   '<div class="d-flex">'
...
<div class="container">
    <h2>Manage Examination Versions</h2>

    <form method="POST" class="row g-3 mb-3" id="createVersionForm">
        ...
        <div class="col-md-3">
            <button type="button" id="createVersionBtn" class="btn w-100" style="background-color: rgb(0, 105, 42); color: white; border: 1px solid rgb(0, 105, 42);" data-bs-toggle="modal" data-bs-target="#createVersionModal" disabled>Create Version</button>
        </div>
        <div class="col-md-3">
            <button type="button" class="btn w-100" style="background-color: #dc3545; color: white; border: 1px solid #dc3545;" data-bs-toggle="modal" data-bs-target="#archivedVersionsModal" id="viewArchivedBtn">
...
<div class="modal fade" id="publishModal" tabindex="-1" aria-labelledby="publishModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        <a href="#" id="publishConfirmLink" class="btn btn-success">Publish</a>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="archiveModal" tabindex="-1" aria-labelledby="archiveModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        <a href="#" id="archiveConfirmLink" class="btn btn-danger">Archive</a>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="restoreModal" tabindex="-1" aria-labelledby="restoreModalLabel" aria-hidden="true" data-bs-backdrop="false">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        <a href="#" id="restoreConfirmLink" class="btn btn-success">Restore</a>
      </div>
    </div>
  </div>
</div>
    ...
    if (versionNameInput && createVersionBtn) {
        ...
        versionNameInput.addEventListener('input', function() {
            ...
            if (hasText) {
                ...
                createVersionBtn.style.backgroundColor = 'rgb(0, 105, 42)';
            } else {
                createVersionBtn.disabled = true;
                createVersionBtn.style.opacity = '0.6';
            }
