...
<div class="row">
      ...
      <div class="card-body">
        ...
        <form method="post" class="row g-3" id="addInterviewerForm">
          ...
          <div class="col-12">
            ...
            <div class="form-text">A temporary password will be sent to this email address.</div>
          </div>
          <div class="col-12">
  ...
  <div class="col-lg-4">
    <div class="card">
      ...
      <div class="card-body">
        <h6>How to add an interviewer:</h6>
        <ol class="small">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showToast(type, message) {
        ...
        toastDiv.id = toastId;
        toastDiv.className = `toast align-items-center ${toastClass} border-0`;
        toastDiv.setAttribute('role', 'alert');
        toastDiv.setAttribute('aria-live', 'assertive');
        toastDiv.setAttribute('aria-atomic', 'true');
        toastDiv.setAttribute('data-bs-delay', '3000');
